...
TEST(WordClock, QuarterPastMidnight)
{
    bool words[TOTAL_WORDS] = { false };
    time_to_words(words, 0, 17);
...
TEST(WordClock, QuarterToOneAM)
{
    bool words[TOTAL_WORDS] = { false };
    time_to_words(words, 0, 49);
...
TEST(WordClock, BasicLedFade)
{
    ...
    uint8_t colour[] = {255, 255, 255};
    interpolate_frame_at_time(led_brightnesses, old_leds, new_leds, 0, colour);
...
TEST(WordClock, QuarterFrame)
{
    ...
    uint8_t colour[] = {255, 255, 255};
    interpolate_frame_at_time(led_brightnesses, old_leds, new_leds, 63, colour);
...
TEST(WordClock, EndFrame)
{
    ...
    uint8_t colour[] = {255, 255, 255};
    interpolate_frame_at_time(led_brightnesses, old_leds, new_leds, 255, colour);
...
TEST(WordClock, EndFrameWithTint)
{
    bool old_leds[] = {true, true, false, false};
    bool new_leds[] = {false, true, true, false};
...
TEST(WordClock, StartFrameWithTint)
{
    bool old_leds[] = {true, true, false, false};
    bool new_leds[] = {false, true, true, false};
...
TEST(WordClock, TransitionIgnoresLedsThatWereOrAreNotTrue)
{
    bool old_leds[] = {false, true, true, false};
    bool new_leds[] = {false, false, true, true};

    uint8_t led_brightnesses[4][3] = {{0}};
    led_brightnesses[0][0] = 1;
    led_brightnesses[0][1] = 2;
    led_brightnesses[0][2] = 3;
